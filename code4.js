...
gdjs.CreditsCode.asyncCallback18460876 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(83), (runtimeScene) => (gdjs.CreditsCode.asyncCallback18460876(runtimeScene, asyncObjectsList)));
}
}
...
{gdjs.evtTools.sound.playMusic(runtimeScene, "assets\\music\\ending.mp3", false, 100, 1);
}
{ //Subevents
